...
const code_blocks = ["Accelerometer","Buttons","Capacitive_Touch","Morse_Code_Starter","Nightlight_starter","Robot_Button_Starter","LCD_Bitmap","LCD_message", "LCD_Text_and_Background","LCD_Turtle","Light_Sensor","Microphone","NeoPixels","Servo","Speaker","Switch_and_red_LED","Temperature","Lab_Robot","Lab_Temp_Sensor","Switch_Buttons_starter","Turtle_Buttons_starter","Song_starter","Robot_Light_starter","Robot_Accelerometer_starter","bluetooth_example"]
...
$(function () {
    ...
    for (let code of code_blocks) {
        console.log(code)
        $.get("https://raw.githubusercontent.com/usma-eecs/CY305_bluefruit/main/lab%20code/"+code+".py", function(data, status){
